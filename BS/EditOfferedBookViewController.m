...
- (void)viewDidLoad
{
    ...
    self.titletext.text=[self.detailItem objectForKey:@"title"];
    self.subtitletext.text=[self.detailItem objectForKey:@"subtitle"];
    self.authortext.text=[self.detailItem objectForKey:@"author"];
    self.ISBNField.text = [self.detailItem objectForKey:@"ISBN"];
    ...
    //font
    self.titletext.font=[UIFont fontWithName:@"AlternateGotNo3D" size:28];
    self.subtitletext.font=[UIFont fontWithName:@"ProximaNovaCond-RegularIt" size:16];
    self.authorlabel.font=[UIFont fontWithName:@"ProximaNovaCond-Regular" size:16];
    self.authortext .tintColor=colorchange(85, 85, 85, 1.0);
    self.isbnlabel.font=[UIFont fontWithName:@"ProximaNovaCond-Regular" size:16];
    self.ISBNField.font=[UIFont fontWithName:@"ProximaNovaCond-Regular" size:16];
    self.PriceField.font=[UIFont fontWithName:@"MuseoSlab-500" size:28];
    self.pricelabel.font=[UIFont fontWithName:@"ProximaNovaCond-Regular" size:16];
    self.LocationField.font=[UIFont fontWithName:@"ProximaNovaCond-Regular" size:23];
    self.locationlabel.font=[UIFont fontWithName:@"ProximaNovaCond-Regular" size:23];
    self.avalabel.font=[UIFont fontWithName:@"ProximaNovaCond-Regular" size:23];
    self.AvalableTimeField.font=[UIFont fontWithName:@"ProximaNovaCond-Regular" size:23];
    self.PostTextView.font=[UIFont fontWithName:@"ProximaNovaCond-Regular" size:23];
    ...
    if(Mark == YES){
        ...
        [self.subtitletext setEditable:NO];
        [self.authortext setEditable:NO];
    }
